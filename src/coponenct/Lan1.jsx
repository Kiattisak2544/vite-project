...
const Lan1 = () => {
    ...
    const [computer, setComputer] = useState([
        { name: 'TNC-OIL-01', ip: '192.168.1.90', anydesk: '1536502635', status: 'checking' },
        { name: 'Bcon_PD003', ip: '192.168.1.155', anydesk: '2180606198', status: 'checking' },
        { name: 'Bcon_PD002', ip: '192.168.1.153', anydesk: '1931398372', status: 'checking' },
        { name: 'TNC-SD-01', ip: '192.168.1.23', anydesk: '1566957871', status: 'checking' },
            ...
            <main className="flex-1 flex flex-col h-screen overflow-y-auto relative">
                ...
                <div className="p-8 space-y-8 pb-20 relative z-0">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                                    ...
                                    <div key={i} className="flex items-center justify-between py-3 px-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0 hover:bg-slate-50 dark:hover:bg-slate-700/30 transition rounded-lg">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-slate-700 dark:text-slate-300 font-medium transition-colors" id="font-label">{router.name}</span>
                                                <span className="text-slate-400 dark:text-slate-500 text-xs font-mono" id="font-label">{router.ip}</span>
                                            </div>
                                        </div>
                        ...
                        <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-6 shadow-lg shadow-slate-200/40 dark:shadow-none flex flex-col transition-colors">
                            <h3 className="text-xl font-extrabold text-slate-800 dark:text-white mb-6 transition-colors font-label" id="font-label">ศุนย์จ่าย</h3>
                            <div className="space-y-4 flex-1">
                                    ...
                                    <div key={index} className="flex items-center justify-between py-3 px-2 border-b border-slate-100 dark:border-slate-700/50 last:border-0 hover:bg-slate-50 dark:hover:bg-slate-700/30 transition rounded-lg">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-red-400 dark:text-red-400 text-xs font-bold" id="font-label">Any desk: {item.anydesk}</span>
                                            </div>
                                        </div>
